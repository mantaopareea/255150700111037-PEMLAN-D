...
public class Main extends Frame implements ActionListener {
    ...
    public Main() {
        ...
        add(asd); asd.setBounds(50, 60, 70, 20);
        add(pemlan); pemlan.setBounds(120, 60, 80, 20);
        add(matkom); matkom.setBounds(200, 60, 90, 20);
        add(probstat); probstat.setBounds(300, 60, 80, 20);

        Label l1 = new Label("Tugas"); add(l1); l1.setBounds(100, 100, 80, 20);
        Label l2 = new Label("Kuis"); add(l2); l2.setBounds(100, 130, 80, 20);
        Label l3 = new Label("UTS"); add(l3); l3.setBounds(100, 160, 80, 20);
        Label l4 = new Label("UAS"); add(l4); l4.setBounds(100, 190, 80, 20);

        txtTugas = new TextField(); add(txtTugas); txtTugas.setBounds(180, 100, 80, 20);
        txtKuis = new TextField(); add(txtKuis); txtKuis.setBounds(180, 130, 80, 20);
        txtUTS = new TextField(); add(txtUTS); txtUTS.setBounds(180, 160, 80, 20);
        txtUAS = new TextField(); add(txtUAS); txtUAS.setBounds(180, 190, 80, 20);

        Label l5 = new Label("Hasil"); add(l5); l5.setBounds(100, 220, 80, 20);
